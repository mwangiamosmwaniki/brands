...
export const PROJECTS: Project[] = [
  {
    ...
    challenge:
      'The business needed a stronger, more consistent identity to feel credible with clients while remaining approachable in a competitive financial services market.',
    services: ['Brand identity design', 'Office branding', 'Print collateral'],
    ...
    result: 'The identity now presents the business as more trustworthy and consistent across the client journey.',
  },
  {
    ...
    challenge:
      'The company needed a booth that could stand out in a crowded event environment while remaining efficient to set up and easy to move between activations.',
    services: ['Exhibition design', 'Event branding', 'Display graphics'],
    ...
    result: 'The exhibition system gave the brand a clearer, more memorable presence at the event.',
  },
  {
    id: 'Wellcare-hospital',
    slug: 'wellcare-hospital',
    ...
    challenge:
      'The facility needed clearer wayfinding and a more consistent visual environment that reassured patients and helped staff guide visitors with confidence.',
    services: ['Healthcare branding', 'Wayfinding signage', 'Environmental graphics'],
    ...
    result: 'Visitors and staff now benefit from a clearer, more reassuring healthcare environment.',
  },
  {
    id: 'velora-lifestyle',
    slug: 'velora-lifestyle',
    ...
    challenge:
      'The brand needed a more premium and consistent look that could carry across packaging, retail touchpoints and customer-facing communications.',
    services: ['Brand identity', 'Packaging design', 'Retail branding'],
    ...
    result: 'The brand has a clearer, more consistent visual identity and retail presentation.',
  },
  {
    id: 'moja-creative',
    slug: 'moja-creative',
    ...
    challenge:
      'The agency wanted its office environment and client materials to communicate the same creative confidence as its own work.',
    services: ['Office branding', 'Promotional materials', 'Interior graphics'],
    ...
    result: 'The space now feels more cohesive, premium and reflective of the agency’s creative work.',
  },
  {
    id: 'riverside-legal',
    ...
    challenge:
      'The firm needed a stronger professional identity that better communicated trust, clarity and authority across everyday client communications.',
    services: ['Brand identity', 'Document design', 'Marketing collateral'],
    ...
    result: 'The practice has a more professional and consistent client-facing identity.',
  },
  {
    id: 'nATURA-BOX',
    slug: 'natura-box',
    ...
    challenge:
      'The product needed packaging that looked premium yet practical on shelf, while aligning with a more natural and sustainable brand story.',
    services: ['Packaging design', 'Retail presentation', 'Label systems'],
    ...
    result: 'The packaging helps the product feel more premium and recognizable in a competitive retail setting.',
  },
  {
    id: 'Swift-fleet',
    slug: 'swift-fleet',
    ...
    challenge:
      'The company needed a recognisable fleet identity that strengthened brand visibility without making vehicles feel cluttered or inconsistent.',
    services: ['Vehicle branding', 'Fleet graphics', 'Corporate signage'],
    ...
    result: 'The brand is more visible and more recognisable across everyday commercial movement.',
  },
];
